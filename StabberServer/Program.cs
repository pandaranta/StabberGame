...
namespace StabberServer
{
    class Program
    {
		...
		static void Main(string[] args)
        {
			...
			string requestIn = encoding.GetString(bufferIn);
			String[] tokens = requestIn.Split(' ');
			if(tokens[0] != "DDO/1.0")
			{
		...
		static void CheckLogIn(string[] tokens)
		{
			...
			response = $"DDO/1.0 LOGIN ACCEPTED {tokens[2]} {tokens[3]}";
		}
